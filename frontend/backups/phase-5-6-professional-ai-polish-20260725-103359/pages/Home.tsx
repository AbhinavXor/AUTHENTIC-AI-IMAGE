  ...
  return (
    ...
    >
      ...
      <div className="compact-attachment-information">
        <div className="compact-attachment-file">
        ...
        <span className="compact-attachment-status">
          {isWorking
            ? 'Serenya is analyzing this image...'
            : status || 'Image ready'}
        </span>
      </div>

      <div className="compact-attachment-actions">
        <button
          className="compact-attachment-action primary"
          disabled={isWorking}
        ...
        <button
          className="compact-attachment-action"
          disabled={isWorking}

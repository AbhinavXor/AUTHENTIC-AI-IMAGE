...
function resolvePdfContinuation(
  ...
  if (
    ...
    return {
      resolvedPrompt:
        `Sirf Page ${nextStartPage} ko explain karo aur [Page ${nextStartPage}] citation use karo.\n\nUser follow-up: ${prompt}`,
    }
  }

  return {
    resolvedPrompt:
      `Sirf Page ${nextStartPage} se Page ${nextFinalPage} tak ek-ek page ko original order mein explain karo. Har page ko uske exact page number ke saath cite karo.\n\nUser follow-up: ${prompt}`,
  }
}
